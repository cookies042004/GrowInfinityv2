...
export const AdminSidebar = ({ mobileMenu }) => {
  ...
  const handleAccordion = (index) => {
    ...
    newAccordions[index] = !newAccordions[index]; // Toggle the state for the clicked accordion
      ...
      <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul className="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              <CategoryIcon className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" />
          ...
          <li>
            ...
            >
              <ArticleIcon className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" />
